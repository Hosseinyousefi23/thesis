...
\lr{Policy Iteration}
  ...
  در این فصل، با فرایندهای تصمیم‌گیری مارکوف آشنا خواهیم‌شد و چهار عنصر اصلی یادگیری تقویتی، یعنی \textit{خط‌مشی}\پاورقی{Policy}، \textit{سیگنال پاداش}\پاورقی{Reward signal}، تابع ارزش \پاورقی{Value Function} و محیط\پاورقی{Environment} را دقیقا تعریف خواهیم‌کرد. همچنین برخی روش‌های کلاسیک در یادگیری تقویتی را معرفی می‌کنیم.
...
$\pi: S \to \Pi(A)$
تابعی است که حالت\nf ها را به توزیع احتمال روی فضای عمل
$\EuScript{A}$
 می\nf نگارد.
به طور خلاصه احتمال انتخاب عمل $a$ در حالت $s$ را به شکل
$\pi(a|s)$
نشان می\nf دهیم.
...
مهمترین مولفه بیشتر الگوریتم‌های یادگیریِ تقویتی که در  این فصل و فصل آینده معرفی می کنیم، روشی برای تخمین کارآمد تابع ارزش است.
