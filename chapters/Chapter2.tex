...
q_\pi(s,a) = \sum_{s',r} p(s',r|s,a)\left[r + \gamma v_\pi(s')\right]	
 ...
 اگر عبارت 
 \ref{eq:policybetter}
 از $v_\pi(s)$ بزرگتر باشد، بدین معناست که انتخاب قطعی عمل $a$ در حالت $s$ و سپس دنبال کردن خط‌مشی $\pi$ بهتر از این است که همواره خط‌مشی $\pi$ را دنبال کنیم. این گزاره را می‌توان به فرم کلی\nf تر در قالب یک قضیه بیان کرد.
...
\ورودی{تقریبی از تابع ارزش حالت مربوط به خط\nf مشی $\pi$،
	$V \approx v_\pi$
}
\به‌ازای{برای هر $s \in \EuScript{S}$}
\دستور{
