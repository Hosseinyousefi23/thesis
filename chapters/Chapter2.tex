...
قضیه \ref{policyimptheorem} یک شرط کافی برای اینکه خط‌مشی $\pi'$ بهتر یا مساوی خط‌مشی $\pi$ باشد را بیان می‌کند. این قضیه می‌تواند ما را به روشی برای بهبود یک خط‌مشی، سوق دهد. منظور ما از بهبود خط‌مشی، روشی برای دستیابی به یک خط‌مشی بهتر، از روی یک خط‌مشی ضعیف تر است.
	فرض کنید $\pi'$ خط مشی معینی باشد که نسبت به تابع ارزش عمل $\q_pi$ حریصانه عمل می کند. به عبارت دیگر
...
با استفاده از قضیه \ref{policytheorem} می توان نشان داد
 \cite{suttonbook}
 $v_\pil(s) \ge v_{\pi}(s)$
بنابراین با استفاده از تابع ارزش خط مشی $\pi$ می\nf توان به یک خط مشی بهتر رسید. می توانیم با استفاده از ارزیابی خط مشی، روی $\pi'$ به تخمینی از $v_{\pi'}$ برسیم؛ سپس می‌توانیم
$v_{\pi'}$
    را محاسبه کرده و مجدداً آن را بهبود بخشیم تا خط مشی باز هم بهتری داشته باشیم. با ادامه دادن این روند، می‌توانیم دنباله‌ای از خط‌مشی‌ها و تابع ارزش‌هایی بدست آوریم که به صورت یکنوا در حال بهبود هستند:
