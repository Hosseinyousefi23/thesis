...
در فصل قبل، با فرایند‌های تصمیم‌گیری مارکوف، معادله بلمن و برنامه‌ریزی پویا آشنا شدیم. در این فصل، به معرفی برخی از مهم\nf ترین الگوریتم‌های یادگیری تقویتی ژرف، مانند
\lr{DQN}،
\lr{TRPO} و 
\lr{Actor-Critic}
  می‌پردازیم. در این فصل، برخی از مهم\nf ترین الگوریتم\nf های 
\قسمت{مسئله یادگیری تقویتی}
در فصل دوم دیدیم که مسئله یادگیری تقویتی، در اصل یک مسئله بهینه سازی است که هدف آن یافتن یک خط\nf مشی بهینه (یا دست\nf کم تقریبی از آن) است که در یک فرآیند تصمیم\nf گیری مارکوف تعریف می\nf شود. یک ترتیب جزئی روی خط\nf مشی\nf ها تعریف کردیم و گفتیم، خط\nf مشی\nf ای که از هر خط\nf مشی دیگری بهتر یا مساوی باشد، خط\nf مشی بهینه است.  نشان دادیم که می\nf توان با محاسبه تابع ارزش یک خط\nf مشی، آن را بهبود بخشید. الگوریتم تکرار خط\nf مشی، با شروع از یک خط مشی تصادفی و بهبود دادن آن به صورت گام\nf به\nf گام، به یک خط\nf مشی بهینه همگرا می\nf شود.  به طور کلی به روش\nf هایی که تلاش می\nf کنند  به روش بهبود گام\nf به\nf گام، مستقیما، خط\nf مشی بهینه  را تقریب بزنند، روش\nf های 
\textit{\مهم{مبتنی بر خط\nf مشی}}
\LTRfootnote{Policy Based}
گفته می\nf شود. بنابراین روش تکرار خط\nf مشی، یک روش مبتنی بر خط\nf مشی است.
 همچنین دیدیم که ممکن است بیشتر از یک خط\nf مشی بهینه وجود داشته باشد، اما همه خط\nf مشی\nf های بهینه، تابع ارزش مشترکی دارند که آن را تابع ارزش بهینه نامیدیم و نشان دادیم، تابع ارزش بهینه در معادلاتی موسوم به معادله بهینگی بلمن صدق می\nf کند. در این فصل، رویکرد جدیدی به مسئله یادگیری تقویتی خواهیم داشت
\شروع{تعریف} فرض کنید 
$\EuScript{M} = \seq{\EuScript{S},\EuScript{A},\EuScript{R},\EuScript{P}, \lambda}$ 
یک فرآیند تصمیم\nf گیری مارکوف است و $\Pi$ مجموعه تمام خط\nf مشی\nf های ممکن برای $\EuScript{M}$ باشد. تابع 
$J: \Pi \to \mathbb{R}$
به شکل زیر تعریف می\nf شود
...
\textit{\مهم{مبتنی بر خط\nf مشی}}\LTRfootnote{Policy Based}
 ...
 رویکرد دیگری که برای حل مسئله یادگیری تقویتی وجود دارد، محاسبه تابع ارزش حالت، یا تابع ارزش عمل بهینه است. منظور از تابع ارزش بهینه، تابع ارزشی است که در معادله بهینگی بلمن صدق کند. برخی از روش\nf های یادگیری تقویتی، روشی برای محاسبه تابع ارزش بهینه با استفاده از معادله بهینگی بلمن ارائه می\nf دهند. به روش\nf هایی که چنین رویکردی دارند، روش\nf های 
 \textit{
 	\مهم{مبتنی بر ارزش
