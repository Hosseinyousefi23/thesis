...
عملگر بلمن و عملگر بهینه، به طور خاص، هردو نگاشتی انقباضی هستند و اعمال مکرر آنها روی یک $Q_0$ اولیه، به صورت نمایی به ترتیب به $Q^\pi$ و $Q^*$ همگرا می‌شود.
 امید ریاضی را از معادله بلمن بیرون بکشیم و در عوض یک توزیع کامل از متغیر تصادفی 
$Z^\pi$ 
قرار دهیم و آن را نگاشتی از دوتایی حالت عمل به توزیعی از عایدی‌ها در نظر می‌گیریم. تابع 
$Z^\pi$ 
را توزیع ارزش می‌نامیم.
\شروع{تعریف}
برای 
$F$
 و 
