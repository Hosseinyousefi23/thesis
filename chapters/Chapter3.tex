...
\فصل{نتایج اخیر}
در فصل قبل، با فرابند های تصمیم گیری مارکوف، معادله بلمن و برنامه ریزی پویا آشنا شدیم. در این فصل، به معرفی برخی از الگوریتم های یادگیری تقویتی مدرن، مانند
\lr{DQN}،
\lr{TRPO} و 
\lr{Actor-Critic}
